...
class TrainerConfig:
    ...
    DIVA_GRPO: bool = False
    Share_VL: bool = False
    Variant_Num: Optional[int] = 1
    Dataset_Mode: Optional[str] = None
    Save_Data: bool = False
    score_ranges: List[List[float]] = field(default_factory=lambda: [
        [0.0, 0.05],
        [0.05, 0.3],
        [0.3, 0.5],
        [0.5, 0.7],
    ...
    difficulty_changes: List[int] = field(default_factory=lambda: [2, 1, 0, -1, -2])
    min_diff: int = 1
    max_diff: int = 9
    weighted_advantage_k: float = 0.1
    All_Log_Path: Optional[str] = None
    DIVA_warmup: bool = False
