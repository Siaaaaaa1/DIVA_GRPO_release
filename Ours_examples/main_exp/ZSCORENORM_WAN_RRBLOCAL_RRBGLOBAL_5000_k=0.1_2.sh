...
python3 -m verl.trainer.main \
    ...
    data.train_files=/mmu_cd_ssd/zhangzhenyu06/workspace/Rebuttal/EasyR1/datasets/OCR/ocr_GRPO_18000.parquet \
    ...
    algorithm.weight_mode="${EXP_NAME}$" \
