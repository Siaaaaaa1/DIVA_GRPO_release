...
python3 -m verl.trainer.main \
    ...
    data.train_files=/mmu_cd_ssd/zhangzhenyu06/workspace/Rebuttal/EasyR1/datasets/OCR/ocr_GRPO_10000.parquet \
    ...
    trainer.score_ranges='[[0.0,0.1],[0.1,0.3],[0.3,0.5],[0.5,0.7],[0.7,1.0]]' \
    trainer.difficulty_changes='[2,1,0,-1,-2]' \
    trainer.weighted_advantage_k=0.05 \
